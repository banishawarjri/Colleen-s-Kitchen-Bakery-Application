...
public class AccountFragment  extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.wrapeer,new ColleensFragment());
                ft.commit();
            }
        });
       ...
       sref= FirebaseDatabase.getInstance().getReference("OrdersInfo");
        ...
        final TextView phno= (TextView)v.findViewById(R.id.accountphone);
        final TextView email=(TextView)v.findViewById(R.id.accountemail);
        final TextView sname=(TextView)v.findViewById(R.id.shipname);
        final TextView sphone=(TextView)v.findViewById(R.id.shipphone);
        ...
        displayvalues(fullname,phno,email);
        displayship(sname,sphone,state,city,locality,pincode);

        return v;

    }

    private void displayship(TextView sname, TextView sphone, TextView state, TextView city, TextView locality, TextView pincode) {
    ...
    private void displayvalues(TextView fullname, TextView phno, TextView email) {

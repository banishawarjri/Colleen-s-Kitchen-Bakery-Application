    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        state.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ConfirmOrderActivity.this,"Deliver Only Within Meghalaya Shillong",Toast.LENGTH_LONG).show();
            }
        });
        ...
        confirm_order.setOnClickListener(new View.OnClickListener() {
            ...
            private void Check() {
                if (TextUtils.isEmpty(person_name.getText().toString())) {
                    ...
                    Toast.makeText(ConfirmOrderActivity.this, "Plese Enter Your City", Toast.LENGTH_LONG).show();
                } else if (TextUtils.isEmpty(locality.getText().toString())) {
                    Toast.makeText(ConfirmOrderActivity.this, "Plese Enter Your Locality", Toast.LENGTH_LONG).show();
                } else if (TextUtils.isEmpty(pincode.getText().toString())) {
                    Toast.makeText(ConfirmOrderActivity.this, "Plese Enter Your Pincode", Toast.LENGTH_LONG).show();
                } else if (TextUtils.isEmpty(del_date.getText().toString())) {
                    Toast.makeText(ConfirmOrderActivity.this, "Plese Enter Your Date of Delivery", Toast.LENGTH_LONG).show();
                } else if (state.getText().toString().equalsIgnoreCase("Meghalaya")) {
                    if (city.getText().toString().equalsIgnoreCase("Shillong")) {
                        if (pincode.getText().toString().length() == 6) {
                            if (Integer.parseInt(pincode.getText().toString()) >= 793001 && Integer.parseInt(pincode.getText().toString()) <= 793022) {
                                    ConfirmOrder();
                            } else {
                        ...
                        Toast.makeText(ConfirmOrderActivity.this, "Deivery Only Within Shillong", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(ConfirmOrderActivity.this, "Invalid Inputs: Delivery only in Meghalaya Shillong", Toast.LENGTH_LONG);
                }
